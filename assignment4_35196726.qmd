...
|---|---|---|---|
| Census year | CLUE | Year of the annual business census (2002–2024) | Numeric |
| CLUE small area | CLUE | Suburb/precinct name within City of Melbourne LGA | Character |
| Trading name | CLUE | Business trading name | Character |
| Business address | CLUE | Full street address of business | Character |
| Industry (ANZSIC4) description | CLUE | Business industry classification | Character |
| Seating type | CLUE | Indoor or outdoor seating | Character |
| Number of seats | CLUE | Licensed seating capacity | Numeric |
| Longitude | CLUE | WGS84 longitude coordinate | Numeric |
| Latitude | CLUE | WGS84 latitude coordinate | Numeric |
| Median_tot_hhd_inc_weekly | ABS G02 | Median weekly household income by SA2 | Numeric |
| Tot_P_P | ABS G01 | Total resident population by SA2 | Numeric |
| SA2_CODE_2021 | ABS Metadata | 9-digit SA2 geographic code | Character |
| SA2_NAME_2021 | ABS Metadata | SA2 suburb name | Character |
| seats_per_1000 | Derived | Café seats per 1,000 residents (total_seats / population × 1000) | Numeric |
...
I expected wealthier suburbs to have more cafés. The data says the opposite and the relationship is statistically significant (p = 0.013, R² = 0.55). Higher income is actually associated with fewer café seats per resident.
...
Also, the weighted mean aggregation then had to be repeated three times — for Southbank, Melbourne CBD, and South Yarra — each of which is split across multiple SA2s in the ABS data.
...
V2: Added equity analysis, suburb bar chart, scatter plot, regression, and references placeholders. Identified the geographic boundary mismatch as a key challenge.
V3: I began to write the content and realized a lot of my initial assumptions about the data were incorrect.Restructured Task 1, made various code changes, completed blog post write-up.
...
- Help troubleshoot coding errors and understand unfamiliar topics such as coordinate reference systems and weighted means.
